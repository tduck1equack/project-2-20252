...
import { StockLevelDto, ApiResponseDto, createSuccessResponse, UserRole } from '@repo/dto';
...
export class StockController {
    ...
    async getStocks(
        ...
        const stocks = await this.stockService.getStocks(req.user.tenantId, warehouseId, search);
