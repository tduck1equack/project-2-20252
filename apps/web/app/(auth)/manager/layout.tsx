            ...
            <div className="flex min-h-screen bg-[rgb(var(--background))]">
                ...
                <aside className="w-64 glass-card border-r border-[rgb(var(--border))] p-4 flex flex-col">
                    ...
                    <Link href="/manager" className="flex items-center gap-3 mb-8 px-2">
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[rgb(var(--accent))] to-[rgb(var(--primary))] flex items-center justify-center">
                            <BarChart3 className="w-6 h-6 text-white" />
                        </div>
                        <div>
                            <span className="font-bold text-lg block">ERP System</span>
                            <span className="text-xs text-[rgb(var(--muted))]">Manager Portal</span>
                        </div>
                    </Link>
                    ...
                    <div className="border-t border-[rgb(var(--border))] pt-4 mt-4">
                        <div className="flex items-center gap-3 px-2">
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[rgb(var(--accent))] to-[rgb(var(--primary))] flex items-center justify-center">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-[rgb(var(--muted))] truncate">{user?.role}</p>
                            </div>
                            <button
